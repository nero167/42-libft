...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/20 08:19:25 by namirtha          #+#    #+#             */
/*   Updated: 2024/03/20 14:08:46 by namirtha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_get_next_word(char **next_word, size_t *next_world_len, char c)
{
	size_t	i;

	*next_word += *next_world_len;
	*next_world_len = 0;
	i = 0;
